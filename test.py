...
form_class = uic.loadUiType("rockscissorpaper.ui")[0]
...
class WindowClass(QMainWindow, form_class) :
    ...
    def loadImageFromFile(self) :
        ...
        self.qPixmapFileVar.load("images/test.png")
        self.qPixmapFileVar = self.qPixmapFileVar.scaledToWidth(600)
        self.graphicsView.setPixmap(self.qPixmapFileVar)
    ...
    def loadImageFromWeb(self) :
        ...
        self.graphicsView.setPixmap(self.qPixmapWebVar)
